    ...
    <div>
        ...
        <div style="margin-left:50px;margin-right:50px;margin-bottom:30px"
            ...
            <p style="font-size:16px;line-height:24px;letter-spacing:-0.2px;margin-bottom:28px"
                ...
                We have completed the deletion process, and your account is no longer available.
                You will no longer have access to any of your data on {{ env('APP_NAME') }}. To reactivate your account,
